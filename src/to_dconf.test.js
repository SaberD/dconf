const { json_dconf } = require('./to_dconf');

describe('json_dconf', () => {
    test('converts JSON object to configuration file format', () => {
        const data = {
            "org": {
                "gnome": {
                    "terminal": {
        ...
        const expectedConf = `[org/gnome/terminal/legacy/profiles:]
list=['b1dcc9dd-5262-4d8d-a863-c897e6d979b9', '571efbab-07ca-48f2-970a-9d6f2c1e413e']
default='571efbab-07ca-48f2-970a-9d6f2c1e413e'
...
bold-color='rgb(137,221,255)'
background-color='rgb(64,60,66)'`;
        expect(json_dconf(data)).toEqual(expectedConf);
    });
});
